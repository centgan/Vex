...
Globalized variables placed in [Global.cpp](https://github.com/centgan/Vex/blob/master/src/sub/Global.cpp) such as defining the motors etc. Main code found in 
[Drive.cpp](https://github.com/centgan/Vex/blob/master/src/sub/Drive.cpp) where drive functions and PID functions. Autos in [Auto.cpp](https://github.com/centgan/Vex/blob/master/src/sub/Auto.cpp)
...
opinion, best motion algorithm. Also use PI don't use D cause there's no point in D cause I helps is the one that helps you settle.
